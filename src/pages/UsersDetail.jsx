...
export default function UserDetail() {
  ...
  if (!user)
    return <div className="p-4 text-gray-500 text-sm">Loading user details...</div>;
      ...
      <div className="bg-white shadow rounded-lg p-6 flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-2 text-sm">
            <span className="bg-gray-100 px-2 py-1 rounded text-gray-700">{user.email}</span>
            <span className="bg-gray-100 px-2 py-1 rounded text-gray-700">{user.phone}</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-5">
          ...
          <div className="space-y-2 text-sm text-gray-700">
            ...
            <p><strong>Address:</strong> {user.company?.address?.address}</p>
        ...
        {/* Section: Identity */}
        <div className="bg-white rounded-lg shadow p-5">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Identity & Access</h2>
          <div className="space-y-2 text-sm text-gray-700">
            ...
            <p><strong>User Agent:</strong> <span className="break-words">{user.userAgent}</span></p>
          </div>
        </div>
      </div>
    </div>
